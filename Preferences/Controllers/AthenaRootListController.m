//
//  AthenaRootListController.m
//  Athena
//
//  Created by Alexandra Aurora Göttlicher
//

#include "AthenaRootListController.h"
#import <Preferences/PSSpecifier.h>
#import <rootless.h>
#import "../PreferenceKeys.h"
#import "../NotificationKeys.h"

@implementation AthenaRootListController
/**
...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier *)specifier {
    ...
    if ([[specifier propertyForKey:@"key"] isEqualToString:kPreferenceKeyEnabled] ||
		[[specifier propertyForKey:@"key"] isEqualToString:kPreferenceKeyAlignment] ||
		[[specifier propertyForKey:@"key"] isEqualToString:kPreferenceKeyUseAmericanFormat]
	) {
...
- (void)promptToRespring {
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Athena" message:@"This option requires a respring to apply. Do you want to respring now?" preferredStyle:UIAlertControllerStyleAlert];
 ...
 */
- (void)promptToReset {
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Athena" message:@"Are you sure you want to reset your preferences?" preferredStyle:UIAlertControllerStyleAlert];
